...
La palabra clave es "en paralelo". El transformer procesa los 2.000 tokens simultáneamente mediante multiplicaciones de matrices masivas. Eso es lo que hace a esta fase **compute-bound** (limitada por capacidad de cómputo): la GPU está ejecutando FLOPs a máxima velocidad, y el cuello de botella es el número de operaciones aritméticas que puede hacer por segundo.
